...
export const getAppKey = () => {
  return localStorage.getItem(CacheKey.APP_KEY) as String | null
}

export const getAppSecret = () => {
  return localStorage.getItem(CacheKey.APP_SECRET) as String | null
}

export const setAppKeyAndSecret = (key: string, secret: string) => {
  localStorage.setItem(CacheKey.APP_KEY, key)
  localStorage.setItem(CacheKey.APP_SECRET, secret)
}

export const clearAppKeyAndSecret = () => {
  localStorage.removeItem(CacheKey.APP_KEY)
  localStorage.removeItem(CacheKey.APP_SECRET)
}
